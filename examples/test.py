...
bus_marker = [dss_tools.static_view.voltage_profile_get_bus_marker("bus_26", annotate=True, annotation_delta_x=-2)]
dss_tools.static_view.voltage_profile(ylim=[0.95, 1.05], buses_marker=bus_marker)

bus_marker = [dss_tools.interactive_view.voltage_profile_get_bus_marker("bus_26", symbol="x", size=30, color="black", annotate=True)]
