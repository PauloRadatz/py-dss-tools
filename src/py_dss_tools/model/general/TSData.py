# -*- encoding: utf-8 -*-
"""
 Created by Ênio Viana at 22/09/2021 at 23:09:52
...
class TSData:
    ...
    @property
    def diashield(self):
        return self.__diashield

    @diashield.setter
    def diashield(self, value):
        self.__diashield = value
    ...
    @property
    def tapelap(self):
        return self.__tapelap

    @tapelap.setter
    def tapelap(self, value):
        self.__tapelap = value

    @property
    def tapelayer(self):
        return self.__tapelayer

    @tapelayer.setter
    def tapelayer(self, value):
        self.__tapelayer = value
